...
def get_pois(df_loc,fl_nam):
    ...
    'restaurant','taxi_station','toilets', 'pub']
    ...
    for posn in range(len(df_loc)):
        ...
        gdf = ox.features.features_from_point(reversed(coordnts[posn]),dist=bufr_zones_mrts,\
        ...
        if gdf.empty:
            ...
            desired_columns = ["element_type", "osmid", "amenity", "geometry"]
