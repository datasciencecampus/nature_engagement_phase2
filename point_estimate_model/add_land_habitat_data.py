...
def get_site_buffers(locations_buffer):
...
def calculate_habitat_areas(sites_habitat_df, locations_buffer):
...
def main():
    ...
    sites_df = get_site_buffers(locations_buffer)

    sites_habitat_df = intersect_with_habitat(sites_df, habitat_df)

    sites_df_habitat_cover_pv = calculate_habitat_areas(sites_habitat_df, locations_buffer)
