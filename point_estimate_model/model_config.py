...
ne_high_quality_sites  = ['Banks_Lane', 'Blue_Anchor_Bay', 'Clevedon', 'Crickley_Hill_Country_Park', 'Doniford_Bridge', 'Fiddlers_Island', 'Galley_Hall', 'Holland_Haven', 'Holme_Dunes_NNR', 'Itchenor', 'Malham_Cove', 'Newlands_Corner', 'Northey_Island_Causeway', 'Ogbourne_St._George_Post', 'Rocket_Post_Field', 'Ryhope_Dene', 'Saltburn', 'Sandwich_Peninsula', 'Sandwich_Peninsula_Bridge', 'Sennen_Cove', 'Strete_Gate', 'Teesdale_Way', 'Undercliffs_Natural_Nature_Reserve', 'Vessey_Pastures', 'Walltown_Quarry']
thames_high_quality_sites  = ['Ash_Ranges_-_Gapemouth_Road_north', 'Ash_Ranges_-_Gapemouth_Road_railway_bridge', 'Ash_Ranges_-_Henley_Park', 'Ash_Ranges_-_Mychett_Place_Road_middle_layby', 'Ash_Ranges_-_Mychett_Place_Road_south_inside_flags', 'Ash_Ranges_-_Nightingale_Road', 'Ash_Ranges_-_Opposite_Potters', 'Ash_Ranges_-_Opposite_Royal_Oak_pub', 'Barossa_-_Kings_Ride', 'Bisley', 'Brentmoor_-_Red_Road', 'Brentmoor_Heath_-_Hare_&_Hounds', 'Broadmoor_Bottom_-_Owlsmoor', 'Bullswater_Common_-_North_Corral', "Caesar's_Camp", 'Castle_Bottom', 'Chobham_Common_-_Burma_Rd', 'Chobham_Common_-_Fishpool', 'Chobham_Common_-_Staple_Hill', 'Crowthorne_-_Devils_Hwy', 'Forest_of_Eversley_-_Aldershot_Road_car_park', 'Forest_of_Eversley_-_Florence_Road', 'Forest_of_Eversley_-_Pedestrian_entrance', 'Hazeley_Heath', 'Heath_Warren_Wood_-_Bramshill_Rd', 'Heath_Warren_Wood_-_St._Neots_Road', 'Heather_Farm_SANG', 'Horsell_Common_-_Horsell_Common_Rd', 'Horsell_Common_-_Near_6-ways_car_park', 'Lightwater_Country_Park_-_Lower', 'Lightwater_Country_Park_-_Upper', 'Ockham_Common', "Sheet's_Heath", "Whitmoor_Common_-_Path_to_St._Mary's_Church", 'Whitmoor_Common_-_Salt_Box_Rd_side', 'Wildmoor_Heath_-_Thibet_Rd', "Wisley_-_Wren's_Nest_Car_Park", 'Yateley_Common_-_A30']
dorset_high_quality_sites  = ['Unnamed:_0', 'Lions_Hill_Heath', 'Canford_Heath', 'Delph_Woods', 'Upton_Country_Park', 'Stour_Valley', 'Poor_Common', 'Iford_Playing_Fields', 'Pugs_Hole', 'Upton_Heath', 'Winfrith_Heath', 'Bog_Lane_Greenspace', 'Lytchett_Heath', 'Talbot_Heath']

t_high_quality_sites  = ['Ash_Ranges_-_Gapemouth_Road_north', 'Ash_Ranges_-_Gapemouth_Road_railway_bridge', 'Ash_Ranges_-_Henley_Park', 'Ash_Ranges_-_Mychett_Place_Road_middle_layby', 'Ash_Ranges_-_Mychett_Place_Road_south_inside_flags', 'Ash_Ranges_-_Nightingale_Road', 'Ash_Ranges_-_Opposite_Potters', 'Ash_Ranges_-_Opposite_Royal_Oak_pub', 'Barossa_-_Kings_Ride', 'Bisley', 'Brentmoor_-_Red_Road', 'Brentmoor_Heath_-_Hare_&_Hounds', 'Broadmoor_Bottom_-_Owlsmoor', 'Bullswater_Common_-_North_Corral', "Caesar's_Camp", 'Castle_Bottom', 'Chobham_Common_-_Burma_Rd', 'Chobham_Common_-_Fishpool', 'Chobham_Common_-_Staple_Hill', 'Crowthorne_-_Devils_Hwy', 'Forest_of_Eversley_-_Aldershot_Road_car_park', 'Forest_of_Eversley_-_Florence_Road', 'Forest_of_Eversley_-_Pedestrian_entrance', 'Hazeley_Heath', 'Heath_Warren_Wood_-_Bramshill_Rd', 'Heath_Warren_Wood_-_St._Neots_Road', 'Heather_Farm_SANG', 'Horsell_Common_-_Horsell_Common_Rd', 'Horsell_Common_-_Near_6-ways_car_park', 'Lightwater_Country_Park_-_Lower', 'Lightwater_Country_Park_-_Upper', 'Ockham_Common', "Sheet's_Heath", "Whitmoor_Common_-_Path_to_St._Mary's_Church", 'Whitmoor_Common_-_Salt_Box_Rd_side', 'Wildmoor_Heath_-_Thibet_Rd', "Wisley_-_Wren's_Nest_Car_Park", 'Yateley_Common_-_A30']
d_high_quality_sites  = ['Unnamed:_0', 'Lions_Hill_Heath', 'Canford_Heath', 'Delph_Woods', 'Upton_Country_Park', 'Stour_Valley', 'Poor_Common', 'Iford_Playing_Fields', 'Pugs_Hole', 'Upton_Heath', 'Winfrith_Heath', 'Bog_Lane_Greenspace', 'Lytchett_Heath', 'Talbot_Heath']
